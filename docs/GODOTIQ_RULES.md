...
GodotIQ has two tiers. Community (free, 22 tools) gives you raw operations — scene editing, runtime control, screenshots, input, scripts. Pro ($19 one-time, all 35 tools) adds the intelligence layer — spatial analysis, code understanding, flow tracing, project memory.
